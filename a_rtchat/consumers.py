...
#         self.user = self.scope['user']
#         self.chatroom_name = self.scope['url_route']['kwargs']['chatroom_name']
#         self.chatroom = get_object_or_404(PrivateChat, private_chatname=self.chatroom_name)
#
#         # اضافه کردن کاربر به گروه WebSocket
#         async_to_sync(self.channel_layer.group_add)(
#             self.chatroom_name, self.channel_name
#         )
#
...
#             'user': self.user
#         }
#         html = render_to_string("a_rtchat/partials/private_chat_message_p.html", context=context)
#         self.send(text_data=html)
